        ...
        <div className='p-5 flex flex-col-reverse lg:flex-row items-center justify-center gap-24'>
            <div>
                <div>
                    ...
                    <form onSubmit={handleForm} className='w-[300px] lg:w-[550px] text-gray-500'>
                        ...
                        <Input className='mt-3' placeholder="Enter Phone" name='number' type="text" required />
                        <Textarea className='mt-3' name='details' placeholder="Write your message here." required rows={8} />
                        <div className='mt-3'>
                            <Button type='submit' className='bg-gradient-to-r from-[#FF9898] to-[#8054FF] px-10 py-1'>Submit</Button>
                        </div>
                    </form>
                </div>
            </div>
